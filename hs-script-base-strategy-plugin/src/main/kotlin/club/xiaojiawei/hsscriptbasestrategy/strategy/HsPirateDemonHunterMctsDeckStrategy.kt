...
class HsPirateDemonHunterMctsDeckStrategy : MCTSDeckStrategy() {
    ...
    override fun executeMCTSOutCard(war: War): List<MCTSArg> {
        ...
        // The released strategy must use the Pirate DH model. The old generic
        // arguments silently bypassed the cannon-first and timing rules and
        // allowed EndTurn to compete with real actions.
        return listOf(
            MCTSArg(
