...
class Card(
    ...
    /** Temporary attack bonus used only while simulating one combat action. */
    var mctsTemporaryAttackBonus: Int = 0
    ...
    public override fun clone(): Card {
        try {
            ...
            card.mctsTemporaryAttackBonus = mctsTemporaryAttackBonus
